...
<div class="sl-logo"><a href="#"><img src="{{ URL::to($row->logo_image ??'') }}" height="70px;" width="80px;"></a></div>
<div class="sl-sideleft">
  ...
  <div class="sl-sideleft-menu">
    <a href="{{ route('admin_dashboard') }}" class="sl-menu-link active">
    ...
    <a href="{{ url('/') }}" class="sl-menu-link">
        <div class="sl-menu-item">
          <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
          <span class="menu-item-label">Go to Website</span>
        </div><!-- menu-item &amp; -->
      </a><!-- sl-menu-link -->
    <a href="{{ route('admin.logo') }}" class="sl-menu-link">
        <div class="sl-menu-item">
          <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
          <span class="menu-item-label">Logo Management</span>
        </div><!-- menu-item &amp; -->
      </a><!-- sl-menu-link -->
  ...
  <a href="{{ route('sub.coupon') }}" class="sl-menu-link">
    <div class="sl-menu-item">
      <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
  ...
  <a href="{{ route('admin.newslater') }}" class="sl-menu-link">
    <div class="sl-menu-item">
      <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
